...
public class AssumptionViolatedExceptionJrTest {
    @DataPoint
    ...
    @Test
    public void AssumptionViolatedExceptionJrWithMatcherDescribesItself() {
    ...
    @Test
    public void simpleAssumptionViolatedExceptionJrDescribesItself() {
